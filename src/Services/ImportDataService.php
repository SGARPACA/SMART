...
class ImportDataService extends ImportService
{
    ...
    public function __construct(
        ...
        parent::__construct($detector, $validatorManager, $entityManager);
    }
     ...
     * @throws \Exception
     */
    public function handleImport(\SplFileObject $file, ImportLog $importLog)
    {
    ...
    public function processResponsibilityChain(
        ...
        $column = isset($configColumns[$header]) ? $configColumns[$header] : new DataTextColumn();
        $data = [
            'column' => $column,
            'value' => $value,
            'rowIndex' => $rowIndex,
     ...
     * @throws \Exception
     */
    public function validateFile(CountableReader $reader, ConfigManagerInterface $configManager)
    {
